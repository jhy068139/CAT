package com.example.cat.database;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public Note getNote(long id) {
        ...
        Cursor cursor = db.query(Note.TABLE_NAME,
                new String[]{Note.COLUMN_ID, Note.COLUMN_TAG, Note.COLUMN_NOTE,Note.COLUMN_SETTINGTIME, Note.COLUMN_TIMESTAMP},
                Note.COLUMN_ID + "=?",
        ...
        Note note = new Note(
                ...
                cursor.getString(cursor.getColumnIndex(Note.COLUMN_SETTINGTIME)),
    ...
    public List<Note> getAllNotes() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                note.setSettingtime(cursor.getString(cursor.getColumnIndex(Note.COLUMN_SETTINGTIME)));
